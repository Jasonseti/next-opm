...
export default function LazyImage({
  ...
  const image_ref = useRef<HTMLAnchorElement>(null);
  ...
  return (
    <>
      {method === "Image" ? (
        <a
          ...
          className={clsx(
            ...
            status === "error" && "rounded-[5px] border-[1.5px] border-white",
      ...
      <div className={clsx(status === "error" ? "block" : "hidden", "m-auto")}>
        <div
          className={clsx(
        ...
        >
          ...
          <h3 className={`text-[4vw] text-center`}>
          ...
          <button
            ...
            className="cursor-pointer mx-auto mt-[2%] px-[25px] rounded-[10px] bg-blue-500 text-l select-none"
          >
            Reload
          </button>
        </div>
