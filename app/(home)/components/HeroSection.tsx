...
function HeroSection() {
  return (
    ...
    >
      ...
      <div className="absolute lg:left-[1.5%] lg:bottom-[2%] bottom-[3%] right-[1.5%]">
        <div className="peer cursor-pointer float-right">
          {/*eslint-disable-next-line @next/next/no-img-element*/}
          <img
            src="/icon/download.svg"
            alt="download_icon"
            className="fill-black w-[max(min(4vw,40px),30px)] rounded-[5px] hover:bg-black/15 h-[max(min(4vw,40px),30px)]"
          ></img>
        </div>
