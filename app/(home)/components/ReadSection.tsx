...
function ChapterListSkeleton() {
  return (
    <div className="w-[90%] h-[max(min(35vw,350px),35px)] rounded-[5px] relative overflow-hidden bg-gray-100 animate-pulse m-auto"></div>
  );
}

function ReadSection({ query }: { query: string }) {
  return (
    <section id="read" className="w-[min(100vw,1400px)] m-auto">
      <div className="w-full pt-[min(6vw,60px)] pb-[min(6vw,50px)] m-auto">
        <Introduction />
