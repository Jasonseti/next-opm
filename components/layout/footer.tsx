  ...
  return (
    <div className="w-[70%] md:w-[100%]">
      ...
      <div className="w-full flex justify-around md:block lg:flex">
        <div className="w-[min(50%,150px)] m-auto sm:m-0 md:m-auto md:w-[80%] lg:w-[40%] outline-[1.5px] aspect-square relative rounded-[100%] overflow-hidden">
          <Image
            fill
...
export function Footer() {
  return (
    <footer className="w-full font-semibold bg-gray-900 text-[max(min(1.6vw,0.9em),0.75em)] text-white">
